...
- [Package (NPM)](https://www.npmjs.com/package/@msinternal/openai_nonazure)
...
### Install the `@msinternal/openai_nonazure` package

Install the OpenAI REST client REST client library for JavaScript with `npm`:

```bash
npm install @msinternal/openai_nonazure
```
