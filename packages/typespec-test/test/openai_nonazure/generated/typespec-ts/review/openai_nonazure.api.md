## API Report File for "@msinternal/openai_nonazure"
...
export class OpenAIClient {
    constructor(endpoint: string, credential: any, options?: OpenAIClientOptions);
    // (undocumented)
...
//
// src/models/models.ts:250:5 - (ae-forgotten-export) The symbol "ChatCompletionResponseMessage" needs to be exported by the entry point index.d.ts
